...
// #define MACHINE_UUID "001ecbf5-8ae4-4282-851f-597ade3a4826"
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define Z_SAFE_HOMING   // This feature is meant to avoid Z homing with probe outside the bed area.
    ...
    #define Z_SAFE_HOMING_X_POINT -25 //(X_MAX_LENGTH/2)    // X point for Z homing when homing all axis (G28)
    #define Z_SAFE_HOMING_Y_POINT -25 //(Y_MAX_LENGTH/2)    // Y point for Z homing when homing all axis (G28)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,796.539914,188.9924188}  // {78.7402,78.7402,200.0*8/3,760*1.1}  // default steps per unit for Ultimaker
