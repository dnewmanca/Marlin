...
#define CUSTOM_MACHINE_NAME "He3D DLT-180"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
//#define MACHINE_UUID "336ae046-8437-4897-af9b-01b76718c2bf"
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 163.75 // mm
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100, 100, 100, 98}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {6000,6000,6000,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
